"""
This module defines a FastAPI router for managing user profiles.
It provides endpoints for creating, retrieving, updating, and deleting user profiles,
    as well as updating accessibility settings.
The endpoints enforce security constraints where administrative privileges are required for creating,
    updating, and deleting profiles, while non-admin users can retrieve their own profiles.
"""
